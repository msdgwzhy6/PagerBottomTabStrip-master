...
import me.majiajie.pagerbottomtabstrip.config.TabLayoutMode;
...
//    int[] testColors = {0xFF00796B,0xFF8D6E63,0xFF2196F3,0xFF607D8B,0xFFF57C00};
    ...
    private void initFragment()
    {
        ...
        mFragments.add(createFragment("sad"));
    ...
    private void BottomTabTest()
    {
        ...
        controller = pagerBottomTabLayout.builder()
                ...
                .addTabItem(android.R.drawable.ic_menu_help, "五个",testColors[0])
                .addTabItem(android.R.drawable.ic_menu_help, "五个",testColors[0])
